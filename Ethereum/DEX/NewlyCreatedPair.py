...
if web3.is_connected():
    print(getTimestamp()," Ethereum Node successfully connected")



#
# pancakeswap factory
pancake_factory = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f'  # Testnet  #0x6725F303b657a9451d8BA641348b6761A6CC7a17
...
liquidityPairAddress = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"

#
#event_filter = contract.events.PairCreated.create_filter(fromBlock=30716374, toBlock=30717588)
...
while True:
    try:
        ...
        if len(events) > 0:
           for event in events:
               if (event['args']['token1'] == "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"):
                   ...
                   print(
                       style.YELLOW + getTimestamp() + " [Token] New Token Detected: " + style.CYAN + tokenName + " (" + tokenSymbol + "): " + style.MAGENTA + tokenAddress + " https://etherscan.io/tx/" + tx_hash + style.RESET)
                   ...
                   print(
                       style.RED + getTimestamp() + " [Token] New Token Detected: " + style.CYAN + tokenName + " (" + tokenSymbol + "): " + style.MAGENTA + tokenAddress + "  https://etherscan.io/tx/" + tx_hash + style.RESET)
