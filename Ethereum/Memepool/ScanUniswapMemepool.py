...
v3router_address='0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45'
...
v3_factoryaddress = '0x1F98431c8aD98523631AE4a59f267346ea31F984'
...
#router_dict={'0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D':True,'0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45':True}
...
sushi_swap= web3.eth.contract(address=sushi_router,abi=sushi_router_abi)

# Get the Uniswap Router contract
router = web3.eth.contract(address=router_address, abi=router_abi)

# Get the Uniswap Factory contract
factory = web3.eth.contract(address=v3_factoryaddress, abi=v3_factory_abi)

routers_dict ={"0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F":True,"0x1111111254fb6c44bAC0beD2854e76F90643097d":True,"0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D":True,"0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45":True,"0x881D40237659C251811CEC9c364ef91dC08D300C":True}
v3pcsContract = web3.eth.contract(address=v3router_address, abi=v3_router_abi)
        ...
        while True:
            ...
            for tx in transactions:
                ...
                if to == v3router_address:
                    ...
                    decoded = router.decode_function_input(data)
                    decoded_str = str(decoded[0])
                    start_index = decoded_str.find(" ") + 1
                    end_index = decoded_str.find("(")
                    function_name = decoded_str[start_index:end_index]
                ...
                elif to == sushi_router:
                    #print(style.MAGENTA + "Universal----Router", to, tx_hash)
